        ...
        function(data) {
          ...
          if($('#type').val() == '' || $('#period').val() == ''){
                ...
                $('#total').val(0.00);
                  ...
                  $('#total').val((($('#amount').value.replace(/,/g, ""))*($('#period').val())).toFixed(2));
...
<div class="row">
    <div class="col-lg-12">
  <h3>New Employee Time Earning</h3>
    ...
    <fieldset>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="" type="text" name="amount" id="amount" onkeypress="totalBalance()" onkeyup="totalBalance()" value="{{{ Input::old('amount') }}}">

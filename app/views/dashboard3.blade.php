...
$pcbs = (strtotime($organization->cbs_support_period)-strtotime(date("Y-m-d"))) / 86400;
 ...
 if(($pfinancial<0 && $organization->erp_license_key ==1) && ($pcbs<0 && $organization->cbs_license_key ==1)){?>
<h4 style="color:red">
                       Your annual support licenses for cbs and financials products have expired!!!....
...
<div class="row">
  ...
  <div class="col-lg-12">
    ...
    <div class="col-lg-4">
    <a href="{{ URL::to('cbsmgmt')}}" id="cbs"><img src="{{asset('public/uploads/images/silhouettes-439150_640.jpg')}}" alt="logo" width="30%">CBS</a>
    </div>

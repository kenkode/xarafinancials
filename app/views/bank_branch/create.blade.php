...
<div class="row">
  ...
  <form>
    ...
    <fieldset>
        ...
        <div class="form-group">
            <label for="username">Bank Branch Sort Code <span style="color:red">*</span> </label>
            <input class="form-control" placeholder="" type="text" name="sort_code" id="sort_code" value="{{{ Input::old('sort_code') }}}">
        </div>

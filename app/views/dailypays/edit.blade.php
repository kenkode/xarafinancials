  ...
  <form>
    <fieldset>
      ...
      <input type="submit" tabindex="-1" style="position:absolute; top:-1000px">
         ...
         <form method="POST" action="{{{ URL::to('dailypays/update/'.$pay->id) }}}" accept-charset="UTF-8">
   
    <fieldset>

       <div class="form-group">
            <label for="username">Employee</label>
            <input class="form-control" placeholder="" type="text" readonly name="employee" id="employee" value="{{ $pay->employee->first_name.' '.$pay->employee->last_name }}">
        </div>              

                    
        <div class="form-group insts" id="insts">
            <label for="username">Days </label>
            <input class="form-control" placeholder="" onkeypress="totalB()" onkeyup="totalB()" type="text" name="days" id="days" value="{{$pay->days}}">
        </div>
        ...
        <div class="form-group">
                        ...
                        <input class="form-control period" readonly="readonly" placeholder="" type="text" name="period" id="period" value="{{$pay->period}}">
                        </div>
        </div>       
        ...
        <div class="form-group">
            ...
            <input class="form-control" readonly placeholder="" onkeypress="totalBalance()" onkeyup="totalBalance()" type="text" name="amount" id="amount" value="{{number_format($pay->amount,2)}}">
           </div>
        ...
        <div class="form-group bal_amt" id="bal">
            ...
            <div class="input-group">
            <span class="input-group-addon">{{$currency->shortname}}</span>
            <input class="form-control" placeholder="" readonly="readonly" type="text" name="balance" id="balance" value="{{number_format($pay->days * $pay->amount,2)}}">
            </div>
        </div>
...
$('.period').datepicker({
    ...
    autoclose: true
        ...
        <div class="form-actions form-group">
          ...
          <button type="submit" class="btn btn-primary btn-sm">Update Employee Daily Pay</button>
        </div>

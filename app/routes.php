    ...
    $organization = Organization::find(Confide::user()->organization_id);   
        ...
        if(Confide::user()->user_type == 'admin'){          
          $employees = Employee::getActiveEmployee();          
            if($organization->is_payroll_active == 1 && $organization->is_erp_active == 1){
...
Route::group(['before' => 'view_employee'], function() {
...
/*
* employee dailypays routes
*/

Route::resource('dailypays', 'DailyPaysController');
Route::post('dailypays/update/{id}', 'DailyPaysController@update');
Route::get('dailypays/delete/{id}', 'DailyPaysController@destroy');
Route::get('dailypays/edit/{id}', 'DailyPaysController@edit');
Route::get('dailypays/view/{id}', 'DailyPaysController@view');
...
Route::group(['before' => 'update_employee'], function() {
Route::get('employees/edit/{id}', 'EmployeesController@edit');
});
Route::post('employees/update/{id}', 'EmployeesController@update');
Route::group(['before' => 'delete_employee'], function() {
...
Route::get('api/salary', function(){
    $id = Input::get('option');
    $employee = Employee::find($id);
    return number_format($employee->basic_pay/30, 2);
});
...
Route::post('erpReports/vatSummary', 'ErpReportsController@vatsummary');
Route::get('erpReports/vatSelect', 'ErpReportsController@vatselect');
...
Route::get('erpquotations/delete/{id}', function($id){

  $order = Erporder::findorfail($id);
           DB::table('erporderitems')->where('erporder_id',$id)->delete();
           Erporder::destroy($id);
